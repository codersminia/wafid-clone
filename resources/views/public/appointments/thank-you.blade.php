...
@section('title', 'Submission Successful - Wafid Medical')
...
<style>
    ...
    .fee-badge { background: #343a40; color: white; padding: 15px 25px; border-radius: 8px; display: inline-block; margin-top: 10px; }
</style>
...
<section class="py-5 bg-light" style="min-height: 90vh; display: flex; align-items: center;">
    <div class="container text-center">
        <div class="thank-you-card">
            ...
            <p class="lead text-muted">Your Medical Examination request has been received and is under review.</p>

            <!-- Reference Section -->
            <div class="reference-box">
                <span class="text-uppercase small font-weight-bold text-muted d-block">Appointment Number</span>
            ...
            <ul class="info-list">
                ...
                <li><strong>Traveling To:</strong> <span>{{ ucfirst(str_replace('-', ' ', $appointment->country_traveling_to)) }}</span></li>
                <li><strong>Token Validity:</strong> <span class="badge badge-success text-white">1 Month</span></li>
            </ul>
                ...
                <div class="row text-left">
                    ...
                    <div class="col-md-6">
                        <ul>
                            ...
                            <li><i class="fas fa-check-circle"></i> 6. Covid Certificate (Optional)</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-danger border-0 text-left mb-4" style="background-color: #ffe6e6; color: #c0392b; border-radius: 8px;">
                <p class="mb-0">
                    ...
                    The actual Medical Center Fee (24,000/-) must be paid directly at the Medical Center.
                </p>
            </div>

            <div class="alert alert-info border-0 text-left mb-5" style="background-color: #e3f2fd; color: #0d47a1; border-radius: 8px;">
                <p class="mb-0">
                    <i class="fas fa-info-circle mr-2"></i> Click the button below to share your <strong>Payment Slip</strong> & <strong>Passport Front Page</strong> for verification.
                </p>
            </div>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-center" style="gap: 15px;">
                @php
                    $wa_message = "Hi, I have submitted my Medical Appointment. Reference: " . $appointment->appointment_no . ". Attached is my payment proof and passport.";
                @endphp
