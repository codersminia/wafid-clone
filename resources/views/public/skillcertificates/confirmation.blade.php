            ...
            <div class="alert alert-warning border-0 mb-4" style="background-color: #fff3cd;">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-right mt-3 mt-md-0">
                        <a href="{{ route('softskill.payLater') }}" class="btn btn-outline-dark font-weight-bold">
                ...
                <div class="card-body p-4">
                    <form id="paymentForm" enctype="multipart/form-data">
                        ...
                        <div class="form-buttons d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('softskill.payLater') }}" class="btn btn-outline-secondary px-5">Pay Later</a>
                        </div>
                    </form>
                </div>
            </div>
