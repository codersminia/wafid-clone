            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl-lg-5">
                    ...
                    <p class="text-muted mb-4">
                        <strong>Gulf Medical Consultant</strong> is a private consultancy firm based in Pakistan. We specialize in assisting workers, students, and travelers in navigating the complex digital requirements for Gulf Cooperation Council (GCC) countries.
                    </p>
                    <p class="text-muted mb-4">
                        We noticed that many skilled workers face difficulties in booking <strong>Wafid (GAMCA) appointments</strong> or registering for <strong>NAVTTC tests</strong> due to technical barriers, lack of credit cards, or confusing forms. We established this platform to solve those problems.
                    </p>
        ...
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="text-muted w-75 mx-auto">
                    You can book directly on official government websites, but here is why thousands of clients choose to pay our service fee instead.
                </p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100 p-3">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted small">Official sites require International Credit Cards. We accept JazzCash, Easypaisa, and Local Bank Transfers.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100 p-3">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted small">One wrong digit in your passport number on the Wafid site means paying the fee again. Our experts verify your data twice.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100 p-3">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted small">We know the availability of medical centers. We help you book "Choice" appointments if you need a specific city.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4 mb-md-0 border-right border-white-50">
                    ...
                    <p class="lead" style="opacity: 0.9">
                        To remove the technical hurdles for Pakistani workers going abroad by providing a secure, fast, and accessible booking platform.
                    </p>
                </div>
                <div class="col-md-6 pl-md-5">
                    <h3 class="font-weight-bold mb-3"><i class="fas fa-eye mr-2"></i> Our Vision</h3>
                    <p class="lead" style="opacity: 0.9">
                        To become the most trusted "One-Stop Solution" for all Gulf visa-related medical and technical requirements in Pakistan.
                    </p>
                </div>
            </div>
        </div>
