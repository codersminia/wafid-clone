                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                            ...
                            <ul class="menu-nav">
                                ...
                                <!-- Wafid Appointments -->
                                <li class="menu-item menu-item-submenu {{ request()->routeIs('admin.appointments*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="{{ route('admin.appointments') }}" class="menu-link menu-toggle">
                                        ...
                                        @if($wafid_new > 0)
                                            <span class="menu-label">
                                                <span class="label label-danger label-inline font-weight-bold">{{ $wafid_new }}</span>
                                            </span>
                                        @endif
                                    </a>                                    
                                </li>   
                                ...
                                <li class="menu-item menu-item-submenu {{ request()->routeIs('admin.special.appointments*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="{{ route('admin.special.appointments') }}" class="menu-link menu-toggle">
                                        ...
                                        @if($special_new > 0)
                                            <span class="menu-label">
                                                <span class="label label-danger label-inline font-weight-bold">{{ $special_new }}</span>
                                            </span>
                                        @endif
                                    </a>                                    
                                </li> 
                                ...
                                <li class="menu-item menu-item-submenu {{ request()->routeIs('admin.tasheer.appointments*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="{{ route('admin.tasheer.appointments') }}" class="menu-link menu-toggle">
                                        ...
                                        @if($tasheer_new > 0)
                                            <span class="menu-label">
                                                <span class="label label-danger label-inline font-weight-bold">{{ $tasheer_new }}</span>
                                            </span>
                                        @endif
                                    </a>                                    
                                </li> 
                                ...
                                <!-- NAVTTC Appointments -->
                                <li class="menu-item menu-item-submenu {{ request()->routeIs('admin.navtech.appointments*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="{{ route('admin.navtech.appointments') }}" class="menu-link menu-toggle">
                                        ...
                                        @if($navtech_new > 0)
                                            <span class="menu-label">
                                                <span class="label label-danger label-inline font-weight-bold">{{ $navtech_new }}</span>
                                            </span>
                                        @endif
                                    </a>                                    
                                </li>                                 
                                ...
                                <li class="menu-item menu-item-submenu {{ request()->routeIs('admin.checkResults*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="{{ route('admin.checkResults') }}" class="menu-link menu-toggle">
                                        ...
                                        @if($medical_new > 0)
                                            <span class="menu-label">
                                                <span class="label label-danger label-inline font-weight-bold">{{ $medical_new }}</span>
                                            </span>
                                        @endif
                                    </a>                                    
                                </li> 
                                ...
                                <li class="menu-item menu-item-submenu {{ request()->routeIs('admin.softskill.appointments*') ? 'menu-item-active' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="{{ route('admin.softskill.appointments') }}" class="menu-link menu-toggle">
                                        ...
                                        @if($softskill_new > 0)
                                            <span class="menu-label">
                                                <span class="label label-danger label-inline font-weight-bold">{{ $softskill_new }}</span>
                                            </span>
                                        @endif
                                    </a>                                    
                                </li>
                                ...
                                <!-- Website Settings -->
                                <li class="menu-item {{ request()->routeIs('admin.settings*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <!-- Payment Methods -->
                                <li class="menu-item {{ request()->routeIs('admin.payment.methods*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <!-- Appointment Fees -->
                                <li class="menu-item {{ request()->routeIs('admin.fees*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <!-- FAQs -->
                                <li class="menu-item {{ request()->routeIs('admin.faqs*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <!-- My Profile -->
                                <li class="menu-item {{ request()->routeIs('admin.profile*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                ...
                                <div class="topbar-item">
                                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                            @if(Auth::user()->avatar)
                                                <img src="{{ asset(Auth::user()->avatar) }}" class="h-100 align-self-end" alt="" />
                                            @else
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">                        
                        <!-- Dynamic Avatar -->
                        <div class="symbol-label" style="background-image: url('{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('assets/admin/media/users/default.jpg') }}');"></div>
                    </div>
                    <div class="d-flex flex-column">
                        <!-- Dynamic Name and Link to Profile -->
                        <a href="{{ route('admin.profile.edit') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
                            {{ Auth::user()->name }}
                        </a>
