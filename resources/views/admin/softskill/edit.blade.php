                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="mt-2">
                                <a href="{{ asset('uploads/softskill/' . $appointment->id_card_front) }}"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="mt-2">
                                <a href="{{ asset('uploads/softskill/' . $appointment->passport_pic) }}"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <img src="{{ asset('uploads/payments/' . $appointment->payment->proof_image) }}"
                                            style="width: 200px; height: auto; border-radius: 5px; box-shadow: 0 0 20px rgba(0,0,0,0.1);">
                                    </div>
                                    <div class="modal-footer">
                                        <a href="{{ asset('uploads/payments/' . $appointment->payment->proof_image) }}"
