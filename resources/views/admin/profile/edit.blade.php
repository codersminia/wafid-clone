                        ...
                        <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-lg-4">
                                    <label class="col-lg-3 col-form-label text-lg-right mb-1 mb-lg-0">Full Name</label>
                                    <div class="col-lg-6">
                                ...
                                <!-- Email -->
                                <div class="form-group row mb-lg-4">
                                    <label class="col-lg-3 col-form-label text-lg-right mb-1 mb-lg-0">Email Address</label>
                                    <div class="col-lg-6">
                                ...
                                <!-- Avatar Input -->
                                <div class="form-group row mb-lg-4">
                                    <label class="col-lg-3 col-form-label text-lg-right mb-1 mb-lg-0">Avatar</label>
                ...
                <div class="col-lg-12">
                    <div class="card card-custom gutter-b">
                        ...
                        <form action="{{ route('admin.profile.update') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-lg-4">
                                    <label class="col-lg-3 col-form-label text-lg-right mb-1 mb-lg-0">New Password</label>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row mb-lg-4">
                                    <label class="col-lg-3 col-form-label text-lg-right mb-1 mb-lg-0">Confirm
                                        Password</label>
                                    <div class="col-lg-6">
