			...
			<form class="form" method="POST" action="{{ route('admin.appointments.update', $appointment->id) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <input type="text" name="first_name" class="form-control"
                                value="{{ old('first_name', $appointment->first_name) }}" >
                            @error('first_name')
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select name="marital_status" class="form-control" required>
                                ...
                                <option value="Widowed" {{ old('marital_status', $appointment->marital_status) == 'Widowed' ? 'selected' : '' }}>Widowed</option>
                            </select>
                    ...
                    @if($appointment->payment)
                        ...
                        <p><strong>Payment Method:</strong> {{ $appointment->payment->payment_method }}</p>
                        <p><strong>Transaction No:</strong> {{ $appointment->payment->transaction_no }}</p>
