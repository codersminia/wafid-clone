                ...
                <div class="card-body">
                    <div class="form-group row mb-lg-4">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            ...
                            <input type="text" name="account_name" class="form-control" placeholder="e.g. Easypaisa, HBL"
                                required>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row mb-lg-4">
                        <div class="col-lg-6 mb-3 mb-lg-0">
                            ...
                            <input type="text" name="account_number" class="form-control" placeholder="Enter number"
                                required>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <div class="image-input image-input-empty image-input-outline" id="kt_image_qr"
                                style="background-image: url({{ asset('assets/admin/media/bg/bg-3.jpg') }})">
                                <div class="image-input-wrapper"></div>

                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                    data-action="change" data-toggle="tooltip" title="Change QR Code">
